...
export interface LMSStore {
  ...
  bookmarks: Bookmark[];
  addBookmark: (bookmark: Omit<Bookmark, 'id' | 'timestamp'>, timestamp: string) => void;
  ...
  addSubject: (boardId: string, classId: string, subjectTitle: string, subjectColor: string) => void;
}
