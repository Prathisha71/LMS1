        ...
        {kpis.map((kpi, idx) => {
          ...
          return (
            <div key={idx} className="glass-card p-5 border-slate-200 dark:border-white/5 flex items-center justify-between">
              <div>
                <span className="text-[10px] text-slate-600 dark:text-slate-400 font-bold uppercase tracking-wider block">{kpi.label}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="glass-card p-6 border-slate-200 dark:border-white/5 bg-gradient-to-r from-brand-royal/10 to-transparent flex flex-col justify-between min-h-[150px]">
              ...
              <button 
                ...
                className="mt-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-300 dark:border-white/5 text-slate-800 dark:text-white hover:bg-slate-200 dark:hover:bg-slate-950 hover:border-brand-royal/30 text-xs font-semibold flex items-center justify-center gap-1 transition-all active:scale-95"
              >
            ...
            <div className="glass-card p-6 border-slate-200 dark:border-white/5 bg-gradient-to-r from-brand-violet/10 to-transparent flex flex-col justify-between min-h-[150px]">
              ...
              <button 
                ...
                className="mt-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-300 dark:border-white/5 text-slate-800 dark:text-white hover:bg-slate-200 dark:hover:bg-slate-950 hover:border-brand-violet/30 text-xs font-semibold flex items-center justify-center gap-1 transition-all active:scale-95"
              >
          ...
          <div className="glass-card p-6 border-slate-200 dark:border-white/5 space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-600 dark:text-slate-500">Hourly student lecture completion rate across chemistry and mathematics.</p>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card p-5 border-slate-200 dark:border-white/5 space-y-4">
            ...
            {submittedAssignments.length === 0 ? (
              <p className="text-xs text-slate-600 dark:text-slate-500 text-center py-8">No homework sheets awaiting review.</p>
            ) : (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <span className="text-[9px] text-slate-600 dark:text-slate-500">{a.subjectTitle} • Submitted by Prathamesh</span>
                      </div>
                      <span className="text-[9px] text-brand-royal dark:text-brand-royal-300 font-mono font-bold bg-slate-100 dark:bg-slate-950 px-1.5 py-0.5 rounded border border-slate-300 dark:border-white/5">
                        .pdf file
                      </span>
                    </div>
                    ...
                    {gradingAssignId === a.id ? (
                      <form onSubmit={handleGradeSubmit} className="space-y-3 border-t border-slate-200 dark:border-white/5 pt-3 animate-fade-in-up">
                        <div className="space-y-1">
                          <label className="text-[9px] font-bold text-slate-600 dark:text-slate-500 uppercase">Input Score / Grade</label>
                          <input 
                            type="text" 
                            value={score} 
                        ...
                        <div className="space-y-1">
                          <label className="text-[9px] font-bold text-slate-600 dark:text-slate-500 uppercase">Tutor Comments</label>
                          <textarea 
                            value={feedback} 
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="w-1/3 py-2 rounded bg-slate-100 dark:bg-slate-950 border border-slate-300 dark:border-white/5 text-[10px] text-slate-700 dark:text-slate-400 font-bold"
                          >
                            Cancel
                          </button>
                          <button
                      ...
                      <button
                        ...
                        className="w-full py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-950 dark:hover:bg-slate-900 border border-slate-300 dark:border-white/5 hover:border-brand-royal/30 text-slate-800 dark:text-white rounded-lg text-[10px] font-bold transition-all flex items-center justify-center gap-1"
                      >
